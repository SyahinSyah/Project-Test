        ...
        <div class="flex h-screen overflow-y-hidden bg-white" x-data="setup()" x-init="$refs.loading.classList.add('hidden')">
          ...
          <div class="flex flex-col flex-1 h-full overflow-hidden">
            ...
            <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
              ...
              >
                <h1 class="text-2xl font-semibold whitespace-nowrap">Company</h1>
              ...
              <h1 class="mt-6 text-2xl font-semibold whitespace-nowrap">List of Company</h1>
              <div class="flex flex-row-reverse p-2"><a href="/createCompany" class="bg-green-200 px-10  rounded-md hover:bg-gray-200">Create</a></div>
                          ...
                          {{-- <template x-for="i in 10" :key="i"> --}}
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                              ...
                              <td class="px-6 py-4 text-sm font-medium text-center whitespace-nowrap">
                                <a href="/company/{{$company->id}}" class="text-indigo-600 hover:text-indigo-900">Update</a>
